            ...
            <div className="about_cont">
                ...
                <div className="typo_div">
                        ...
                        <Typography id="box" style={{fontWeight:"light"}} className="desc_box"
                            variant="subtitle1"
                            color="initial">
                            I am from Kolkata, West Bengal,completed my graduation in Bcom (Account. Honours) from Umes Chandra College, Calcutta University,
                            I have completed Full Stack Web development course from Masai.
                            Having problem-solving ability and proficiency in MERN Stack, I am a quick learner and always curious to learn new things.
                            As a Full Stack Developer, I am equipped with the knowledge and skills to write clean and efficient code that is necessary to build a web applications from the frontend to the backend.
                             {/* I am a detail-oriented and dedicated individual who has a passion for creating innovative and functional software solutions. */}  
